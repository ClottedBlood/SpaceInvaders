...
public class EnemyShip : Enemy
{
   ...
   private float randomDistanceMultipier = 0.3f;
   [SerializeField]
   ...
   public override void  PositionEnemy()
   {
    ...
    float minDistance = distanceFromTarget * (1f - randomDistanceMultipier);
    float maxDistance = distanceFromTarget * (1f + randomDistanceMultipier);
